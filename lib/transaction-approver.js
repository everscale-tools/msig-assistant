...
function buildTransactionsIterationTask(client, txIterationStateDb, accountsFilter, txConfirmationQueue) {
    ...
    return cb => {
        Async.waterfall([
            ...
            cb => {
                debug(`Transaction iterator initialized: ${JSON.stringify(iterator, null, 2)}`);
